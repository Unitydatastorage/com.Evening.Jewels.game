...
namespace MatchThreeEngine
{
    public sealed class GameBoard : MonoBehaviour
    {
        ...
        void ResetGridForNextLevel()
        {
            ...
            score = 0;
            scoreGame.text = $"Points: {score}/350";
        ...
        void GameVictory()
        {
            ...
            if (winPanel != null)
            {
                ...
                {
                    winTextComponent.text = $"Points: {score}/350";
                }
                else
                {
        ...
        void GameLoss()
        {
            ...
            scoreLose.text = $"Points: {score}/350";
            StopTimer();
        ...
        private async Task<bool> TryMatchAsync()
        {
            ...
            while (match != null)
            {
                ...
                if (tiles.Length >= 5)
                {
                    matchPoints += 10; // Additional 10 points for 4 or more tiles
                }

                score += matchPoints;
                scoreGame.text = "Points: " + score + "/350"; // Update score text
